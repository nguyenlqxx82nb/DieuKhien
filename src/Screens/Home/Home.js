                ...
                <View style={{ flex: 1, paddingLeft: 20, paddingRight: 20, paddingTop: 10, paddingBottom: 10 }}>
                    <Grid>
                        <Row size={1}>
                            <Grid>
                                <Col size={1}>
                                    <LinearGradient start={{ x: 0.0, y: 0 }} end={{ x: 0.9, y: 0.7 }} colors={['#FF8888', '#EE4B4C', '#DB0909']} style={[styles.container3, { backgroundColor: "#DE1313" }]}>
                                ...
                                <Col size={1}>
                                    <LinearGradient start={{ x: 0.0, y: 0 }} end={{ x: 0.9, y: 0.7 }}
                                        locations={[0.3, 0.6, 1]} colors={['#FFF70A', '#FFBB06', '#FF5A01']} style={[styles.container3, { backgroundColor: "#FF7B03" }]}>
                        ...
                        <Row size={1}>
                            ...
                            <Col size={1}>
                                <LinearGradient colors={['#FF99CC', '#BD4ED4', '#7F08DC']} style={[styles.container3, { backgroundColor: "#A230D8" }]}>
                        ...
                        <Row size={1}>
                            <LinearGradient start={{ x: 0.0, y: 0 }} end={{ x: 0.9, y: 0.7 }}
                                locations={[0.1, 0.4, 1]} colors={['#7DC4E3', '#59A3DB', '#3481D3']} style={[styles.container3, { backgroundColor: "#4994D8" }]}>
                                <IconRippe vector={true} name="musicOnline" size={80} text={{
                                    content: "NHẠC ONLINE", layout: 1,
                                }} textStyle = {styles.labelRight} />
                            </LinearGradient>
                        </Row>
                    </Grid>
                </View>
